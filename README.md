# CP1404 Programming 2
  This repo contains my practical work for JCU's CP1404 - Programming 2 subject. I've updated this weekly and use it to keep notes about how I'm tracking along in the subjects e.g. what practical feedback I recieve.

## Clean Code
  Things about clean code that I've learnt during this subject:
  - You spend more time reading then writing code so make sure that the code is easily readable. Readability is more important than effeciency.
  - Funcation names should always be indicitave of what that function is actually doing.
  - Words mean things, if you use an adjective make sure it's the correct one e.g. 'get' would imply you are 'getting' something likely from the user.
...
## Practicals
  ...
  ## Links
 [Programming Patters](https://github.com/CP1404/Starter/wiki/Programming-Patterns)
 [CP1404 Practical Submissions](https://github.com/CP1404/Practicals/blob/master/README.md#submission)
 [CP1404 Practicals](https://github.com/CP1404/Practicals/tree/master)
 [Weekly Code Review Order](https://github.com/CP1404/Starter/wiki/Code-Review-Order)
